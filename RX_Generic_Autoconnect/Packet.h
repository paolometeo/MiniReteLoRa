...
float  Volt1q;   //  rms di Volt1
float  Volt2q;   //  rms di Volt2
float  curr1q;   //  rms di curr1
float  curr2q;   //  rms di curr2
};
...
//AdafruitIO_Feed *Rapp = io.feed("Rapp");
AdafruitIO_Feed *curr1q = io.feed("RMScorBat");
AdafruitIO_Feed *curr2q = io.feed("RMScorFV");
AdafruitIO_Feed *Volt1q = io.feed("RMSvoltBat");
AdafruitIO_Feed *Volt2q = io.feed("RMSvoltFV");
