...
//   Clear the receiving buffer
      ...
      display.clear();
      display.drawString(0,0,"ID: " + String(ID_TX));
      display.drawString(64,0,"np: " + String(npacket));
      display.drawString(0,11,"nRSSI: " + String(nRSSI));
      display.drawString(64,11,"Bat: " + String(vBatTX));
      display.display();
      Received = 1;
      return Received;
  }
