...
// Transmission
  ...
  if(ECHO){
    ...
    Serial.print(" npulse ");Serial.print(minni.Data12140.npulse);
    Serial.print(" Per ");Serial.print(minni.Data12140.Per);
    Serial.print(" Irain ");Serial.print(minni.Data12140.Irain);
    Serial.print(" WetnessA ");Serial.print(minni.Data12140.WetnessA);
    Serial.print(" WetnessB ");Serial.print(minni.Data12140.WetnessB);
    Serial.println();
  }
